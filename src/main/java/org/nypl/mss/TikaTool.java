...
class TikaTool{
    ...
    public TikaTool(File file) throws IOException, TikaException{
        tika = new Tika();
        this.file = file;
        persNameFinder = new NameFinderME(new TokenNameFinderModel(new FileInputStream(new File("src/main/resources/models/en-ner-person.bin"))));
        orgNameFinder = new NameFinderME(new TokenNameFinderModel(new FileInputStream(new File("src/main/resources/models/en-ner-organization.bin"))));
        locNameFinder = new NameFinderME(new TokenNameFinderModel(new FileInputStream(new File("src/main/resources/models/en-ner-location.bin"))));
        parseFile();
